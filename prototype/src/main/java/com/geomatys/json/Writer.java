...
public class Writer {
    ...
    public String write(final CoordinateReferenceSystem impl) throws JsonProcessingException {
        return mapper.writeValueAsString(com.geomatys.json.pojo.Crs.create(impl));
    }
    ...
    public String write(final Datum impl) throws JsonProcessingException {
        return mapper.writeValueAsString(com.geomatys.json.pojo.Datum.create(impl));
    }
    ...
    public String write(final CoordinateSystem impl) throws JsonProcessingException {
        return mapper.writeValueAsString(com.geomatys.json.pojo.CoordinateSystem.create(impl));
    }
    ...
    public String write(final CoordinateOperation impl) throws JsonProcessingException {
        return mapper.writeValueAsString(com.geomatys.json.pojo.CoordinateOperation.create(impl));
    }
}
