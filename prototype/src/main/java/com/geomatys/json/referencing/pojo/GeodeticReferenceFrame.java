    ...
    extends Datum
{
    ...
    public GeodeticReferenceFrame(org.opengis.referencing.datum.GeodeticDatum datum) {
        super(datum);
        primeMeridian = new PrimeMeridian(datum.getPrimeMeridian());
        ellipsoid = new Ellipsoid(datum.getEllipsoid());
    }
}
