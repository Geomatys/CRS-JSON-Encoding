...
public class Writer {
    ...
    public String write(final GeodeticCRS crs) throws JsonProcessingException {
        return write(crs.getDatum());   // TODO
    }

    public String write(final GeodeticDatum datum) throws JsonProcessingException {
        return mapper.writeValueAsString(new com.geomatys.json.referencing.pojo.GeodeticReferenceFrame(datum));
    }
}
