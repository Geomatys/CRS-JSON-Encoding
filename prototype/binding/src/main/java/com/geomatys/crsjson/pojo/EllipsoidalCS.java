 ...
 */
public final class EllipsoidalCS extends CoordinateSystem
        implements org.opengis.referencing.cs.EllipsoidalCS
{
     ...
     */
    protected EllipsoidalCS(final org.opengis.referencing.cs.EllipsoidalCS impl) {
        super(impl);
     ...
     */
    public static EllipsoidalCS create(org.opengis.referencing.cs.EllipsoidalCS impl) {
        return (impl == null || impl instanceof EllipsoidalCS)
                ? (EllipsoidalCS) impl : new EllipsoidalCS(impl);
    }
}
